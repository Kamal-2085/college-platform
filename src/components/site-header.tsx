            ...
            <div ref={menuRef} className="relative">
              ...
              {menuOpen ? (
                <div
                  ...
                  className="absolute right-0 top-[calc(100%+0.75rem)] w-56 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950/95 p-2 shadow-2xl shadow-black/40 backdrop-blur"
                >
